...
default:
    ...
    var i = function() {
        ...
        return t.prototype.render = function(t) {
            var o = k(this.markup);
            if (this.options && this.options.contents && o.html(this.options.contents), this.options && this.options.className && o.addClass(this.options.className), this.options && this.options.data && k.each(this.options.data,
            function(t, e) {
                o.attr("data-" + t, e)
    ...
    var n = function() {
        ...
        return t.prototype.show = function() {
            "body" === this.options.target ? (this.$backdrop.css("position", "fixed"), this.$modal.css("position", "fixed")) : (this.$backdrop.css("position", "absolute"), this.$modal.css("position", "absolute")),
    ...
    f = t('<button type="button" class="note-btn" role="button" tabindex="-1">',
    function(t, e) {
        e && e.tooltip && (t.attr({
    ...
    m = t('<div class="note-dropdown-menu" role="list">',
    function(t, i) {
    ...
    g = t('<div class="note-dropdown-menu note-check" role="list">',
    function(t, i) {
        var e = $.isArray(i.items) ? i.items.map(function(t) {
            var e = "string" == typeof t ? t: t.value || "",
            o = i.template ? i.template(t) : t,
    ...
    v = t('<div class="note-color-palette"/>',
    function(t, e) {
    ...
    b = t('<div class="note-modal" aria-hidden="false" tabindex="-1" role="dialog"/>',
    function(t, e) {
    ...
    y = t(['<div class="note-popover bottom">', '  <div class="note-popover-arrow"/>', '  <div class="popover-content note-children-container"/>', "</div>"].join(""),
    function(t, e) {
        var o = void 0 !== e.direction ? e.direction: "bottom";
        t.addClass(o).hide(),
        e.hideArrow && t.find(".note-popover-arrow").hide()
    }),
    C = t('<div class="checkbox"></div>',
    function(t, e) {
    ...
    var A = /Edge\/\d+/.test(I),
    F = !!window.CodeMirror;
    if (!F && S) if ("function" == typeof __webpack_require__) try {
        require.resolve("codemirror"),
        F = !0
    } catch(t) {} else if ("undefined" != typeof require) if (void 0 !== require.resolve) try {
        require.resolve("codemirror"),
        F = !0
    } catch(t) {} else void 0 !== require.specified && (F = require.specified("codemirror"));
    ...
    var j = {
        ...
        unique: function(t) {
            for (var e = [], o = 0, n = t.length; o < n; o++) U(e, t[o]) || e.push(t[o]);
            return e
        }
    },
    q = {
    ...
    var Lt = {
        ...
        walkPoint: function(t, e, o, n) {
            for (var i = t; i && (o(i), !It(i, e));) i = Tt(i, n && t.node !== i.node && e.node !== i.node)
        },
        ancestor: pt,
        ...
        listDescendant: function(i, r) {
            ...
            function t(e) {
                i !== e && r(e) && s.push(e);
                for (var o = 0,
                n = e.childNodes.length; o < n; o++) t(e.childNodes[o])
            } (i),
            s
        },
        commonAncestor: function(t, e) {
            for (var o = ft(t), n = e; n; n = n.parentNode) if ( - 1 < k.inArray(n, o)) return n;
            return null
        },
        wrap: function(t, e) {
            var o = t.parentNode,
    ...
    function Ht(t, e) {
        ...
        for (o = 0; o < s.length; o++) if (!Lt.isText(s[o])) {
        ...
        if (0 !== o && Lt.isText(s[o - 1])) {
            ...
            l = l.nextSibling;
            l.nodeValue;
            e && l.nextSibling && Lt.isText(l.nextSibling) && d === l.nodeValue.length && (d -= l.nodeValue.length, l = l.nextSibling),
            i = l,
            o = d
        }
        return {
    ...
    var Bt = function() {
        ...
        r.prototype.normalize = function() {
            var t = function(t, e) {
                if (Lt.isVisiblePoint(t) && !Lt.isEdgePoint(t) || Lt.isVisiblePoint(t) && Lt.isRightEdgePoint(t) && !e || Lt.isVisiblePoint(t) && Lt.isLeftEdgePoint(t) && e || Lt.isVisiblePoint(t) && Lt.isBlock(t.node) && Lt.isEmpty(t.node)) return t;
        ...
        r.prototype.nodes = function(o, t) {
            ...
            s = [],
            a = [];
            return Lt.walkPoint(e, r,
            function(t) {
                var e;
                Lt.isEditable(t.node) || (i ? (Lt.isLeftEdgePoint(t) && a.push(t.node), Lt.isRightEdgePoint(t) && j.contains(a, t.node) && (e = t.node)) : e = n ? Lt.ancestor(t.node, o) : t.node, e && o(e) && s.push(e))
            },
            !0),
            j.unique(s)
        },
        ...
        r.prototype.splitText = function() {
            ...
            Lt.isText(this.sc) && !Lt.isEdgePoint(this.getStartPoint()) && (e.sc = this.sc.splitText(this.so), e.so = 0, t && (e.ec = e.sc, e.eo = this.eo - this.so)),
        ...
        r.prototype.deleteContents = function() {
            ...
            n = Lt.prevPointUntil(t.getStartPoint(),
            function(t) {
        ...
        r.prototype.wrapBodyInlineWithPara = function() {
            if (Lt.isBodyContainer(this.sc) && Lt.isEmpty(this.sc)) return this.sc.innerHTML = Lt.emptyPara,
        ...
        r.prototype.getWordRange = function(t) {
            ...
            var o = Lt.prevPointUntil(e,
            function(t) {
                return ! Lt.isCharPoint(t)
            });
            return t && (e = Lt.nextPointUntil(e,
            function(t) {
                return ! Lt.isCharPoint(t)
            })),
    ...
    zt = {
        ...
        createFromNode: function(t) {
            ...
            n = t,
            i = Lt.nodeLength(n);
            return Lt.isVoid(e) && (o = Lt.listPrev(e).length - 1, e = e.parentNode),
            Lt.isBR(n) ? (i = Lt.listPrev(n).length - 1, n = n.parentNode) : Lt.isVoid(n) && (i = Lt.listPrev(n).length, n = n.parentNode),
            this.create(e, o, n, i)
        },
    ...
    Ut = function() {
        ...
        t.prototype.outdent = function(t) {
            ...
            function(t, e) {
                var o = j.head(e);
                Lt.isLi(o) ? n.releaseList([e]) : k.each(e,
                function(t, e) {
                    k(e).css("marginLeft",
                    function(t, e) {
    ...
    jt = function() {
        ...
        return t.prototype.insertTab = function(t, e) {
            var o = Lt.createText(new Array(e + 1).join(Lt.NBSP_CHAR)); (t = t.deleteContents()).insertNode(o, !0),
    ...
    qt = function(t, h, p, i) {
        ...
        function() {
            for (var t = i.rows,
            e = 0; e < t.length; e++) for (var o = t[e].cells, n = 0; n < o.length; n++) r(t[e], o[n])
        } ()
    };
    qt.where = {
        Row: 0,
    ...
    var Kt, Vt = function() {
        ...
        t.prototype.addCol = function(t, e) {
            ...
            for (var i = new qt(o, qt.where.Column, qt.requestAction.Add, k(n).closest("table")[0]).getActionList(), r = 0; r < i.length; r++) {
                ...
                case qt.resultAction.SumSpanCount:
                    ...
                    } else k(s.baseCell).before("<td" + a + ">" + Lt.blank + "</td>")
                }
            }
        },
        ...
        t.prototype.deleteRow = function(t) {
            for (var e = Lt.ancestor(t.commonAncestor(), Lt.isCell), o = k(e).closest("tr"), n = o.children("td, th").index(k(e)), i = o[0].rowIndex, r = new qt(e, qt.where.Row, qt.requestAction.Delete, k(o).closest("table")[0]).getActionList(), s = 0; s < r.length; s++) if (r[s]) {
                var a = r[s].baseCell,
                l = r[s].virtualTable,
        ...
        t.prototype.deleteCol = function(t) {
            for (var e = Lt.ancestor(t.commonAncestor(), Lt.isCell), o = k(e).closest("tr"), n = o.children("td, th").index(k(e)), i = new qt(e, qt.where.Column, qt.requestAction.Delete, k(o).closest("table")[0]).getActionList(), r = 0; r < i.length; r++) if (i[r]) switch (i[r].action) {
            case qt.resultAction.Ignore:
                continue;
            case qt.resultAction.SubtractSpanCount:
                var s = i[r].baseCell;
    ...
    Wt = function() {
        function t(t) {
            ...
            this.insertNode = this.wrapCommand(function(t) {
                u.isLimited(k(t).text().length) || (u.createRange().insertNode(t), zt.createFromNodeAfter(t).select())
            }),
        ...
        return t.prototype.initialize = function() {
            ...
            function(t) {
                if (t.keyCode === K.code.ENTER && e.context.triggerEvent("enter", t), e.context.triggerEvent("keydown", t), t.isDefaultPrevented() || (e.options.shortcuts ? e.handleKeyMap(t) : e.preventDefaultEditableShortCuts(t)), e.isLimited(1, t)) return ! 1
            }).on("keyup",
            function(t) {
        ...
        t.prototype.preventDefaultEditableShortCuts = function(t) { (t.ctrlKey || t.metaKey) && j.contains([66, 73, 85], t.keyCode) && t.preventDefault()
        },
        ...
        t.prototype.onFormatBlock = function(t, e) {
            if (t = L.isMSIE ? "<" + t + ">": t, document.execCommand("FormatBlock", !1, t), e && e.length) {
                var o = e[0].className || "";
                if (o) {
        ...
        t.prototype.fontStyling = function(t, e) {
            ...
            if (o) {
                ...
                if (k(n).css(t, e), o.isCollapsed()) {
                    var i = j.head(n);
                    i && !Lt.nodeLength(i) && (i.innerHTML = Lt.ZERO_WIDTH_NBSP_CHAR, zt.createFromNodeAfter(i.firstChild).select(), this.$editable.data("bogus", i))
                }
            }
        },
        t.prototype.unlink = function() {
            var t = this.createRange();
            if (t.isOnAnchor()) {
                var e = Lt.ancestor(t.sc, Lt.isAnchor); (t = zt.createFromNode(e)).select(),
                this.beforeCommand(),
    ...
    Gt = function() {
        ...
        t.prototype.attachDragAndDropEvent = function() {
            ...
            this.documentEventHandlers.onDragenter = function(t) {
                ...
                e || n.length || !o || (i.$editor.addClass("dragover"), i.$dropzone.width(i.$editor.width()), i.$dropzone.height(i.$editor.height()), r.text(i.lang.image.dragImageHere)),
                n = n.add(t.target)
            },
            this.documentEventHandlers.onDragleave = function(t) { (n = n.not(t.target)).length || i.$editor.removeClass("dragover")
            },
            ...
            function(t) {
                ...
                t.preventDefault(),
                n && n.files && n.files.length ? (i.$editable.focus(), i.context.invoke("editor.insertImagesOrCallback", n.files)) : k.each(n.types,
                function(t, e) {
    ...
    L.hasCodeMirror && (L.isSupportAmd ? require(["codemirror"],
    function(t) {
        Kt = t
    ...
    var Yt = function() {
        ...
        t.prototype.activate = function() {
            var e = this;
            if (this.$codable.val(Lt.html(this.$editable, this.options.prettifyHtml)), this.$codable.height(this.$editable.height()), this.context.invoke("toolbar.updateCodeview", !0), this.$editor.addClass("codeview"), this.$codable.focus(), L.hasCodeMirror) {
    ...
    Zt = function() {
        ...
        return t.prototype.initialize = function() {
            ...
            function(t) {
                ...
                n.$document.on("mousemove", e).one("mouseup",
                function() {
        ...
        return t.prototype.initialize = function() {
            ...
            function(t) {
                if (Lt.isControlSizing(t.target)) {
                    ...
                    r.$document.on("mousemove", i).one("mouseup",
                    function(t) {
                        t.preventDefault(),
    ...
    ne = function() {
        ...
        return t.prototype.representShortcut = function(t) {
            ...
            return this.options.shortcuts && e ? (L.isMac && (e = e.replace("CMD", "⌘").replace("SHIFT", "⇧")), " (" + (e = e.replace("BACKSLASH", "\\").replace("SLASH", "/").replace("LEFTBRACKET", "[").replace("RIGHTBRACKET", "]")) + ")") : ""
        },
        ...
        t.prototype.colorPalette = function(h, t, o, n) {
            ...
            return this.ui.buttonGroup({
                ...
                children: [this.button({
                    ...
                    callback: function(t) {
                        var e = t.find(".note-recent-color");
                        o && (e.css("background-color", "#FFFF00"), t.attr("data-backColor", "#FFFF00")),
        ...
        t.prototype.addToolbarButtons = function() {
            ...
            function() {
                ...
                return k.each(t["font-family"].split(","),
                function(t, e) {
                    e = e.trim().replace(/['"]+/g, ""),
    ...
    re = function() {
        ...
        t.prototype.bindEnterKey = function(t, e) {
            t.on("keypress",
            function(t) {
                t.keyCode === K.code.ENTER && (t.preventDefault(), e.trigger("click"))
            })
        },
    ...
    ae = function() {
        ...
        t.prototype.showImageDialog = function() {
            ...
            return k.Deferred(function(e) {
                ...
                i.ui.onDialogShown(i.$dialog,
                function() {
                    i.context.triggerEvent("dialog.shown"),
                    t.replaceWith(t.clone().on("change",
                    function(t) {
    ...
    pe = function() {
        ...
        t.prototype.handleKeydown = function(t) {
            this.$popover.is(":visible") && (t.keyCode === K.code.ENTER ? (t.preventDefault(), this.replace()) : t.keyCode === K.code.UP ? (t.preventDefault(), this.moveUp()) : t.keyCode === K.code.DOWN && (t.preventDefault(), this.moveDown()))
        },
        ...
        t.prototype.createGroup = function(e, t) {
            ...
            return this.searchKeyword(e, t,
            function(t) { (t = t || []).length && (n.html(o.createItemTemplates(e, t)), o.show())
            }),
            n
        },
        t.prototype.handleKeyup = function(t) {
    ...
    fe = function() {
        ...
        t.prototype._initialize = function() {
            ...
            var n = k.extend({},
            this.options.modules, k.summernote.plugins || {});
        ...
        t.prototype.initializeModule = function(t) {
            ...
            e.shouldInitialize() && (e.initialize && e.initialize(), e.events && Lt.attachEvents(this.$note, e.events))
        },
        ...
        t.prototype.removeModule = function(t) {
            var e = this.modules[t];
            e.shouldInitialize() && (e.events && Lt.detachEvents(this.$note, e.events), e.destroy && e.destroy()),
    ...
    k.fn.extend({
        summernote: function() {
            ...
            o = "object" === t,
            i = k.extend({},
            k.summernote.options, o ? j.head(arguments) : {});
            i.langInfo = k.extend(!0, {},
            k.summernote.lang["en-US"], k.summernote.lang[i.lang]),
            i.icons = k.extend(!0, {},
            k.summernote.options.icons, i.icons),
