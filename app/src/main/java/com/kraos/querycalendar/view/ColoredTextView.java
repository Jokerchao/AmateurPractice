...
public class ColoredTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    private static final int CORNER_RADIUS = (int) DpUtil.dp2px(4);
    private static final int X_PADDING = (int) DpUtil.dp2px(16);
    private static final int Y_PADDING = (int) DpUtil.dp2px(8);
